...
setwd(r'(D:\Dropbox\git\data-stems-joe\graph-results)')
gold1 <- read.csv('gold1.csv')
gold2 <- read.csv('gold2.csv')
gold3 <- read.csv('gold3.csv')
comphi1 <- read.csv('comp-hi1.csv')
comphi2 <- read.csv('comp-hi2.csv')
comphi3 <- read.csv('comp-hi3.csv')
complo1 <- read.csv('comp-lo1.csv')
complo2 <- read.csv('comp-lo2.csv')
complo3 <- read.csv('comp-lo3.csv')
livehi1 <- read.csv('live-hi1.csv')
livehi2 <- read.csv('live-hi2.csv')
livehi3 <- read.csv('live-hi3.csv')
livelo1 <- read.csv('live-lo1.csv')
livelo2 <- read.csv('live-lo2.csv')
livelo3 <- read.csv('live-lo3.csv')
...
figname <- 'Fig1-mAP.50'
source('graph-results-mAP.5.R')

## Graph mean avg precision 95 ####
# Make plot canvas
figname <- 'Fig2-mAP.95'
source('graph-results-mAP.95.R')

## Graph Recall ####
# Make plot canvas
figname <- 'Fig3-recall'
source('graph-results-recall.R')

## Graph Training loss ####
# Make plot canvas
figname <- 'Fig4-training-loss'
source('graph-results-train-loss.R')

## Graph Validation loss ####
# Make plot canvas
figname <- 'Fig5-val-loss'
source('graph-results-val-loss.R')
